...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UsesId        int64                  `protobuf:"varint,1,opt,name=uses_id,json=usesId,proto3" json:"uses_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterResponse) GetUsesId() int64 {
	if x != nil {
		return x.UsesId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\auses_id\x18\x01 \x01(\x03R\x06usesId\"W\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x14Z\x12salem.sso.v1.ssoy1b\x06proto3"
